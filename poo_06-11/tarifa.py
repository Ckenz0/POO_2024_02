...
if __name__ == "__main__":
    ...
    print(pagamento.processar_pagamento(valor_transacao))
    
    pagamento2 = Pagamento(estrategia_vip)
    print(pagamento2.processar_pagamento(valor_transacao))

    pagamento3 = Pagamento(estrategia_especial)
    print(pagamento3.processar_pagamento(valor_transacao))
